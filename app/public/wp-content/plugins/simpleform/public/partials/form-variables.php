...
$empty_data = array( 'name' => '','lastname' => '','email' => '','phone' => '','subject' => '','message' => '','terms' => '','captcha' => '','captcha_one' => '','captcha_two' => '','username' => '','telephone' => '' );
...
$wrap_class = $label_position == 'inline' ? 'class="col-sm-10"' : '';
...
$rtl_class = $form_direction == 'rtl' ? 'class="rtl"' : '';
...
$form_attribute = $html5_validation == 'true' ? $rtl_class .' novalidate' : $rtl_class;