...
$form .= '<div id="sform-message" '.$wrap_class.'><span tabindex="-1" class="message '.$alert_class.'">'.$error_fields_message.'</span>'.$error_script.'</div>';

// Submit field
$form .= '<div id="sform-submit-wrap" '.$wrap_class.'><button name="submission" id="submission" type="submit" class="btn btn-primary">'.$submit_label.'</button></div></form>'; 

// Text below Contact Form
$form .= '<div id="sform-bottom" '.$rtl_class.'><p>'.$bottom_text.'</p></div>';
