...
// Submit field
$form .= '<div id="sform-submit-wrap" '.$wrap_class.'><button name="submission" id="submission" type="submit" class="btn btn-outline-secondary rounded-pill">'.$submit_label.'</button></div></form>'; 
