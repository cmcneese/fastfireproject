 ...
 * Description:       Create a basic contact form for your website. Lightweight, fast and very simple to manage, SimpleForm is immediately ready to use.
 * Version:           1.6
 * Author:            WPSForm Team
...
define( 'SIMPLEFORM_VERSION', '1.6' );
define( 'SIMPLEFORM_DB_VERSION', '1.5' );
