...
<tr><th class="option"><span><?php esc_html_e('HTML5 Validation', 'simpleform' ) ?></span></th><td class="checkbox"><label for="html5-validation"><input name="html5-validation" type="checkbox" class="sform" id="html5-validation" value="false" <?php checked( $html5_validation, 'true'); ?> ><?php esc_html_e('Disable the browser default form validation','simpleform') ?></label></td></tr>
...
$firstname_error_message = ! empty( $sform_settings['firstname_error_message'] ) && preg_replace('/[^0-9]/', '', $sform_settings['firstname_error_message']) == $firstname_length ? stripslashes(esc_attr($sform_settings['firstname_error_message'])) : sprintf( __('Please enter at least %d characters', 'simpleform' ), $firstname_length );
...
$lastname_error_message = ! empty( $sform_settings['lastname_error_message'] ) && preg_replace('/[^0-9]/', '', $sform_settings['lastname_error_message']) == $lastname_length ? stripslashes(esc_attr($sform_settings['lastname_error_message'])) : sprintf( __('Please enter at least %d characters', 'simpleform' ), $lastname_length );
...
$subject_error_message = ! empty( $sform_settings['subject_error_message'] ) && preg_replace('/[^0-9]/', '', $sform_settings['subject_error_message']) == $subject_length ? stripslashes(esc_attr($sform_settings['subject_error_message'])) : sprintf( __('Please enter a subject at least %d characters long', 'simpleform' ), $subject_length );
...
$object_error_message = ! empty( $sform_settings['object_error_message'] ) && preg_replace('/[^0-9]/', '', $sform_settings['object_error_message']) == $message_length ? stripslashes(esc_attr($sform_settings['object_error_message'])) : sprintf( __('Please enter a message at least %d characters long', 'simpleform' ), $message_length );
...
<tr class="<?php if ( $firstname_field =='hidden' || $firstname_length == 0) {echo 'unseen';}?>"><th class="option"><span><?php esc_html_e('Name Length Error','simpleform') ?></span></th><td class="text"><input class="sform" name="firstname_error_message" placeholder="<?php esc_html_e('Please enter an inline error message to be displayed below the field in case of empty field or name not enough long','simpleform') ?>" id="firstname_error_message" type="text" value="<?php echo $firstname_error_message; ?>" \></td></tr>
...
<tr class="<?php if ( $lastname_field =='hidden' || $lastname_length == 0) {echo 'unseen';}?>"><th class="option"><span><?php esc_html_e('Lastname Length Error','simpleform') ?></span></th><td id="td-name-error" class="text"><input class="sform" name="lastname_error_message" placeholder="<?php esc_html_e('Please enter an inline error message to be displayed below the field in case of empty field or lastname not enough long','simpleform') ?>" id="lastname_error_message" type="text" value="<?php echo $lastname_error_message; ?>" \></td></tr>
...
<tr class="<?php if ( $email_field =='hidden' ) {echo 'unseen';}?>"><th class="option"><span><?php esc_html_e('Invalid Email Error','simpleform') ?></span></th><td class="text"><input class="sform" name="email_error_message" placeholder="<?php esc_html_e('Please enter an inline error message to be displayed below the field in case of empty field or invalid email','simpleform') ?>" id="email_error_message" type="text" value="<?php echo $email_error_message; ?>" \></td></tr>
...
<tr class="<?php if ( $subject_field =='hidden' || $subject_length == 0) {echo 'unseen';}?>"><th class="option"><span><?php esc_html_e('Subject Length Error','simpleform') ?></span></th><td class="text"><input type="text" class="sform" id="subject_error_message" name="subject_error_message" placeholder="<?php esc_html_e('Please enter an inline error message to be displayed below the field in case of empty field or subject not enough long','simpleform') ?>" value="<?php echo $subject_error_message; ?>" \></td></tr>
...
<tr><th class="option"><span><?php esc_html_e('Message Length Error','simpleform') ?></span></th><td class="text"><input type="text" class="sform" name="object_error_message" placeholder="<?php esc_html_e('Please enter an inline error message to be displayed below the field in case of empty field or message not enough long','simpleform') ?>" id="object_error_message"  value="<?php echo $object_error_message; ?>" \></td></tr>
...
<tr class="<?php if ( $captcha_field =='hidden' ) {echo 'unseen';}?>"><th class="option"><span><?php esc_html_e('Invalid Captcha Error','simpleform') ?></span></th><td class="text"><input class="sform" name="captcha_error_message" placeholder="<?php esc_html_e('Please enter an inline error message to be displayed below the field in case of empty field or invalid captcha value','simpleform') ?>" id="captcha_error_message" type="text" value="<?php echo $captcha_error_message; ?>" \></td></tr>
...
<tr><th class="last option"><span><?php esc_html_e('Honeypot Field Error','simpleform') ?></span></th><td class="last text"><input class="sform" name="honeypot_error" placeholder="<?php esc_html_e('Please enter an error message to be displayed below the form in case of a honeypot field is filled in','simpleform') ?>" id="honeypot_error" type="text" value="<?php echo $honeypot_error; ?>" \></td></tr>
