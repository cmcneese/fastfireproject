...
<?php
$empty_fields_message = ! empty( $sform_settings['empty_fields_message'] ) ? stripslashes(esc_attr($sform_settings['empty_fields_message'])) : esc_attr__( 'Mandatory fields must be filled in', 'simpleform' );
...
$firstname_error_message = ! empty( $sform_settings['firstname_error_message'] ) ? stripslashes(esc_attr($sform_settings['firstname_error_message'])) : sprintf( __('Please enter at least %d characters', 'simpleform' ), $firstname_length );
...
$lastname_error_message = ! empty( $sform_settings['lastname_error_message'] ) ? stripslashes(esc_attr($sform_settings['lastname_error_message'])) : sprintf( __('Please enter at least %d characters', 'simpleform' ), $lastname_length );
$invalid_lastname_error_message = ! empty( $sform_settings['invalid_lastname_error'] ) ? stripslashes(esc_attr($sform_settings['invalid_lastname_error'])) : esc_attr__( 'The lastname contains characters that are not allowed', 'simpleform' );
...
$subject_error_message = ! empty( $sform_settings['subject_error_message'] ) ? stripslashes(esc_attr($sform_settings['subject_error_message'])) : sprintf( __('Please enter a subject at least %d characters long', 'simpleform' ), $subject_length );
...
$object_error_message = ! empty( $sform_settings['object_error_message'] ) ? stripslashes(esc_attr($sform_settings['object_error_message'])) : sprintf( __('Please enter a message at least %d characters long', 'simpleform' ), $message_length );
...
<tr><th id="" class="first option"><span><?php esc_html_e('Empty Fields Error','simpleform') ?></span></th><td id="" class="first text"><input class="sform" name="empty_fields_message" placeholder="<?php esc_html_e('Please enter an error message in case of multiple empty fields','simpleform') ?>" id="empty_fields_message" type="text" value="<?php echo $empty_fields_message; ?>" \></td></tr>

<tr class="<?php if ( $firstname_length == 0) {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Lenght Firstname Error','simpleform') ?></span></th><td class="text"><input class="sform" name="firstname_error_message" placeholder="<?php esc_html_e('Please enter an error message in case of empty field or firstname not enough long','simpleform') ?>" id="firstname_error_message" type="text" value="<?php echo $firstname_error_message; ?>" \></td></tr>
        
<tr><th class="option"><span><?php esc_html_e('Invalid Firstname Error','simpleform') ?></span></th><td class="text"><input type="text" class="sform" id="invalid_name_error" name="invalid_name_error" placeholder="<?php esc_html_e('Please enter an error message in case of invalid firstname','simpleform') ?>" value="<?php echo $invalid_firstname_error_message; ?>" \></td></tr>

<tr><th class="option"><span><?php esc_html_e('Firstname Field Error','simpleform') ?></span></th><td class="text"><input class="sform" name="name_error" placeholder="<?php esc_html_e('Please enter a message in case of error in firstname field','simpleform') ?>" id="name_error" type="text" value="<?php echo $name_error; ?>" \></td></tr>
		

<tr class="<?php if ( $lastname_length == 0) {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Lenght Lastname Error','simpleform') ?></span></th><td id="td-name-error" class="text"><input class="sform" name="lastname_error_message" placeholder="<?php esc_html_e('Please enter an error message in case of empty field or lastname not enough long','simpleform') ?>" id="lastname_error_message" type="text" value="<?php echo $lastname_error_message; ?>" \></td></tr>
        
<tr><th class="option"><span><?php esc_html_e('Invalid Lastname Error','simpleform') ?></span></th><td class="text"><input type="text" class="sform" id="invalid_lastname_error" name="invalid_lastname_error" placeholder="<?php esc_html_e('Please enter an error message in case of invalid lastname','simpleform') ?>" value="<?php echo $invalid_lastname_error_message; ?>" \></td></tr>

<tr><th class="option"><span><?php esc_html_e('Lastname Field Error','simpleform') ?></span></th><td class="text"><input class="sform" name="lastname_error" placeholder="<?php esc_html_e('Please enter a message in case of error in lastname field','simpleform') ?>" id="lastname_error" type="text" value="<?php echo $lastname_error; ?>" \></td></tr>
...
<tr><th class="option"><span><?php esc_html_e('Invalid Phone Error','simpleform') ?></span></th><td class="text"><input class="sform" name="phone_error_message" placeholder="<?php esc_html_e('Please enter an error message in case of invalid phone number','simpleform') ?>" id="phone_error_message" type="text" value="<?php echo $phone_error_message; ?>" \></td></tr>

<tr><th class="option"><span><?php esc_html_e('Phone Field Error','simpleform') ?></span></th><td class="text"><input class="sform" name="phone_error" placeholder="<?php esc_html_e('Please enter a message in case of error in phone field','simpleform') ?>" id="phone_error" type="text" value="<?php echo $phone_error; ?>" \></td></tr>

<tr class="<?php if ( $subject_length == 0) {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Lenght Subject Error','simpleform') ?></span></th><td class="text"><input type="text" class="sform" id="subject_error_message" name="subject_error_message" placeholder="<?php esc_html_e('Please enter an error message in case of empty field or subject not enough long','simpleform') ?>" value="<?php echo $subject_error_message; ?>" \></td></tr>
...
<tr class="smtp heading <?php if ($smtp_configuration =='true') {echo 'unseen';} else {echo 'visible';} ?>"><th class="heading" colspan="2"><span id="misc"><?php esc_html_e( 'SMTP Server Configuration', 'simpleform' ) ?></span><span id="smpt-warnings"><?php esc_html_e( 'Show Configuration Warnings', 'simpleform' ) ?></span></th></tr>		
