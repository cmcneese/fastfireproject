...
<div id="tab-messages" class="settings-tab hidden">
...
$lastname_error_message = ! empty( $sform_settings['lastname_error_message'] ) ? stripslashes(esc_attr($sform_settings['lastname_error_message'])) : esc_attr__( 'Please enter at least 2 characters', 'simpleform' );
...
<tr><th id="th-name-error" class="first option"><span><?php esc_html_e('Lenght Firstname Error','simpleform') ?></span></th><td id="td-name-error" class="first text"><input class="sform" name="firstname_error_message" placeholder="<?php esc_html_e('Please enter an error message in case of empty field or firstname not enough long','simpleform') ?>" id="firstname_error_message" type="text" value="<?php echo $firstname_error_message; ?>" \></td></tr>
...
<tr><th id="th-name-error" class="option"><span><?php esc_html_e('Lenght Lastname Error','simpleform') ?></span></th><td id="td-name-error" class="text"><input class="sform" name="lastname_error_message" placeholder="<?php esc_html_e('Please enter an error message in case of empty field or lastname not enough long','simpleform') ?>" id="lastname_error_message" type="text" value="<?php echo $lastname_error_message; ?>" \></td></tr>
...
<div id="tab-email" class="settings-tab hidden">
