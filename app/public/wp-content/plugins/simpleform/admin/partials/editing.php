...
<tr class="trname <?php if ( $firstname_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Firstname Field Label Visibility','simpleform') ?></span></th><td class="checkbox"><label for="namelabel"><input name="firstname_spotlight" type="checkbox" class="sform field-label" id="namelabel" value="<?php echo $firstname_spotlight ?>" <?php checked( $firstname_spotlight, 'hidden'); ?>><?php esc_html_e('Hide label for firstname field','simpleform') ?></label></td></tr>

<tr class="trname namelabel <?php if ( $firstname_field =='hidden' || $firstname_spotlight =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Firstname Field Label','simpleform') ?></span></th><td class="text"><input class="sform" name="firstname_label" placeholder="<?php esc_html_e('Enter a label for Firstname field','simpleform') ?>" id="firstname_label" type="text" value='<?php echo $firstname_label; ?>'</td></tr>		
		
<tr class="trname <?php if ( $firstname_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Firstname Field Placeholder','simpleform') ?></span></th><td class="text"><input class="sform" name="firstname_placeholder" placeholder="<?php esc_html_e('Enter a placeholder for Firstname field. If blank, will not be used!','simpleform') ?>" id="firstname_placeholder" type="text" value='<?php echo $firstname_placeholder; ?>'</td></tr>		

<tr class="trname <?php if ( $firstname_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e( 'Firstname Minimum Length', 'simpleform' ) ?></span></th><td class="text"><input name="firstname_minlength" id="firstname_minlength" type="number" class="sform" min="0" max="80" value="<?php echo $firstname_minlength;?>"><span class="description left"><?php esc_html_e('Notice that 0 means no minimum limit','simpleform') ?></span></td></tr>

<tr class="trname <?php if ( $firstname_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e( 'Firstname Maximum Length', 'simpleform' ) ?></span></th><td class="text"><input name="firstname_maxlength" id="firstname_maxlength" type="number" class="sform" min="0" max="80" value="<?php echo $firstname_maxlength;?>"><span class="description left"><?php esc_html_e('Notice that 0 means no maximum limit','simpleform') ?></span></td></tr>

<tr class="trname <?php if ( $firstname_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Firstname Field Requirement','simpleform') ?></span></th><td class="checkbox"><label for="firstname_requirement"><input name="firstname_requirement" type="checkbox" class="sform" id="firstname_requirement" value="required" <?php checked( $firstname_requirement, 'required'); ?>><?php esc_html_e('Make this field required','simpleform') ?></label></td></tr>
...
<tr class="trlastname <?php if ( $lastname_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option" ><span><?php esc_html_e( 'Lastname Field Layout', 'simpleform' ) ?></span></th><td class="radio"><fieldset><label for="single-line"><input id="single-line" type="radio" name="lastname-alignment" value="alone" <?php checked( $lastname_alignment, 'alone'); ?> ><?php esc_html_e( 'Place on a single line','simpleform') ?></label><label for="name-line" ><input id="name-line" type="radio" name="lastname-alignment" value="name" <?php checked( $lastname_alignment, 'name'); ?> ><?php esc_html_e( 'Place next to firstname field on the same line','simpleform') ?></label></fieldset></td></tr>

<tr class="trlastname <?php if ( $lastname_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Lastname Field Label Visibility','simpleform') ?></span></th><td class="checkbox"><label for="lastnamelabel"><input name="lastname_spotlight" type="checkbox" class="sform field-label" id="lastnamelabel" value="visible" <?php checked( $lastname_spotlight, 'hidden'); ?>><?php esc_html_e('Hide label for lastname field','simpleform') ?></label></td></tr>

<tr class="trlastname lastnamelabel <?php if ( $lastname_field =='hidden' || $lastname_spotlight =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Lastname Field Label','simpleform') ?></span></th><td class="text"><input class="sform" name="lastname_label" placeholder="<?php esc_html_e('Enter a label for Lastname field','simpleform') ?>" id="lastname_label" type="text" value='<?php echo $lastname_label; ?>'</td></tr>		

<tr class="trlastname <?php if ( $lastname_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Lastname Field Placeholder','simpleform') ?></span></th><td class="text"><input class="sform" name="lastname_placeholder" placeholder="<?php esc_html_e('Enter a placeholder for Lastname field. If blank, will not be used!','simpleform') ?>" id="lastname_placeholder" type="text" value='<?php echo $lastname_placeholder; ?>'</td></tr>		

<tr class="trlastname <?php if ( $lastname_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e( 'Lastname Minimum Length', 'simpleform' ) ?></span></th><td class="text"><input name="lastname_minlength" id="lastname_minlength" type="number" class="sform" min="0" max="80" value="<?php echo $lastname_minlength;?>"><span class="description left"><?php esc_html_e('Notice that 0 means no minimum limit','simpleform') ?></span></td></tr>

<tr class="trlastname <?php if ( $lastname_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e( 'Lastname Maximum Length', 'simpleform' ) ?></span></th><td class="text"><input name="lastname_maxlength" id="lastname_maxlength" type="number" class="sform" min="0" max="80" value="<?php echo $lastname_maxlength;?>"><span class="description left"><?php esc_html_e('Notice that 0 means no maximum limit','simpleform') ?></span></td></tr>

<tr class="trlastname <?php if ( $lastname_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Lastname Field Requirement','simpleform') ?></span></th><td class="checkbox"><label for="lastname_requirement"><input name="lastname_requirement" type="checkbox" class="sform" id="lastname_requirement" value="required" <?php checked( $lastname_requirement, 'required'); ?>><?php esc_html_e('Make this field required','simpleform') ?></label></td></tr>
...
<tr class="tremail <?php if ( $email_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Email Field Label Visibility','simpleform') ?></span></th><td class="checkbox"><label for="emaillabel"><input name="email_spotlight" type="checkbox" class="sform field-label" id="emaillabel" value="visible" <?php checked( $email_spotlight, 'hidden'); ?>><?php esc_html_e('Hide label for email field','simpleform') ?></label></td></tr>

<tr class="tremail emaillabel <?php if ( $email_field =='hidden' || $email_spotlight =='hidden' ) { echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span ><?php esc_html_e('Email Field Label','simpleform') ?></span></th><td class="text"><input class="sform" name="email_label" placeholder="<?php esc_html_e('Enter a label for Email field','simpleform') ?>" id="email_label" type="text" value="<?php echo $email_label; ?>"</td></tr>

<tr class="tremail <?php if ( $email_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Email Field Placeholder','simpleform') ?></span></th><td class="text"><input class="sform" name="email_placeholder" placeholder="<?php esc_html_e('Enter a placeholder for Email field. If blank, will not be used!','simpleform') ?>" id="email_placeholder" type="text" value='<?php echo $email_placeholder; ?>'</td></tr>		
		
<tr class="tremail <?php if ( $email_field =='hidden') { echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Email Field Requirement','simpleform') ?></span></th><td class="checkbox"><label for="email_requirement"><input name="email_requirement" type="checkbox" class="sform" id="email_requirement" value="required" <?php checked( $email_requirement, 'required'); ?>><?php esc_html_e('Make this field required','simpleform') ?></label></td></tr>
...
<tr class="trphone <?php if ( $phone_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option" ><span><?php esc_html_e( 'Phone Field Layout', 'simpleform' ) ?></span></th><td class="radio"><fieldset><label for="single-line"><input id="single-line" type="radio" name="phone-alignment" value="alone" <?php checked( $phone_alignment, 'alone'); ?> ><?php esc_html_e( 'Place on a single line','simpleform') ?></label><label for="email-line" ><input id="email-line" type="radio" name="phone-alignment" value="email" <?php checked( $phone_alignment, 'email'); ?> ><?php esc_html_e( 'Place next to email field on the same line','simpleform') ?></label></fieldset></td></tr>

<tr class="trphone <?php if ( $phone_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Phone Field Label Visibility','simpleform') ?></span></th><td class="checkbox"><label for="phonelabel"><input name="phone_spotlight" type="checkbox" class="sform field-label" id="phonelabel" value="visible" <?php checked( $phone_spotlight, 'hidden'); ?>><?php esc_html_e('Hide label for phone field','simpleform') ?></label></td></tr>

<tr class="trphone phonelabel <?php if ( $phone_field =='hidden' || $phone_spotlight =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Phone Field Label','simpleform') ?></span></th><td class="text"><input class="sform" name="phone_label" placeholder="<?php esc_html_e('Enter a label for Phone field','simpleform') ?>" id="phone_label" type="text" value='<?php echo $phone_label; ?>'</td></tr>		

<tr class="trphone <?php if ( $phone_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Phone Field Placeholder','simpleform') ?></span></th><td class="text"><input class="sform" name="phone_placeholder" placeholder="<?php esc_html_e('Enter a placeholder for Phone field. If blank, will not be used!','simpleform') ?>" id="phone_placeholder" type="text" value='<?php echo $phone_placeholder; ?>'</td></tr>		

<tr class="trphone <?php if ( $phone_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Phone Field Requirement','simpleform') ?></span></th><td class="checkbox"><label for="phone_requirement"><input name="phone_requirement" type="checkbox" class="sform" id="phone_requirement" value="required" <?php checked( $phone_requirement, 'required'); ?>><?php esc_html_e('Make this field required','simpleform') ?></label></td></tr>
...
<tr class="trsubject subjectlabel <?php if ($subject_field =='hidden' || $subject_spotlight =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Subject Field Label','simpleform') ?></span></th><td class="text"><input class="sform" name="subject_label" placeholder="<?php esc_html_e('Enter a label for Subject field','simpleform') ?>" id="subject_label" type="text" value="<?php echo $subject_label; ?>"></td></tr>

<tr class="trsubject <?php if ( $subject_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e('Subject Field Placeholder','simpleform') ?></span></th><td class="text"><input class="sform" name="subject_placeholder" placeholder="<?php esc_html_e('Enter a placeholder for Subject field. If blank, will not be used!','simpleform') ?>" id="subject_placeholder" type="text" value='<?php echo $subject_placeholder; ?>'</td></tr>		

<tr class="trsubject <?php if ( $subject_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e( 'Subject Minimum Length', 'simpleform' ) ?></span></th><td class="text"><input name="subject_minlength" id="subject_minlength" type="number" class="sform" min="0" max="80" value="<?php echo $subject_minlength;?>"><span class="description left"><?php esc_html_e('Notice that 0 means no minimum limit','simpleform') ?></span></td></tr>

<tr class="trsubject <?php if ( $subject_field =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>" ><th class="option"><span><?php esc_html_e( 'Subject Maximum Length', 'simpleform' ) ?></span></th><td class="text"><input name="subject_maxlength" id="subject_maxlength" type="number" class="sform" min="0" max="80" value="<?php echo $subject_maxlength;?>"><span class="description left"><?php esc_html_e('Notice that 0 means no maximum limit','simpleform') ?></span></td></tr>

<tr class="trsubject <?php if ($subject_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Subject Field Requirement','simpleform') ?></span></th><td class="checkbox"><label for="subject_requirement"><input name="subject_requirement" type="checkbox" class="sform" id="subject_requirement" value="required" <?php checked( $subject_requirement, 'required'); ?>><?php esc_html_e('Make this field required','simpleform') ?></label></td></tr>
...
<tr class="messagelabel <?php if ( $message_spotlight =='hidden' ) {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Message Field Label','simpleform') ?></span></th><td class="text"><input class="sform" name="message_label" placeholder="<?php esc_html_e('Enter a label for Message field','simpleform') ?>" id="message_label" type="text" value="<?php echo $message_label; ?>"</td></tr>
...
<tr class="trterms <?php if ($terms_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Terms Field Label','simpleform') ?></span></th><td class="text notes"><input class="sform" name="terms_label" placeholder="<?php esc_html_e('Enter a label for Terms field','simpleform') ?>" id="terms_label" type="text" value="<?php echo $terms_label; ?>" \><p id="description-terms" class="description"><?php esc_html_e('Entering URL requires the use of html tags','simpleform') ?></p></td></tr>

<tr class="trterms <?php if ($terms_field =='hidden') {echo 'unseen';} else {echo 'visible';} ?>"><th class="option"><span><?php esc_html_e('Terms Field Requirement','simpleform') ?></span></th><td class="checkbox notes"><label for="terms_requirement"><input name="terms_requirement" type="checkbox" class="sform" id="terms_requirement" value="required" <?php checked( $terms_requirement, 'required'); ?>><?php esc_html_e('Make this field required','simpleform') ?></label><p class="description"><?php esc_html_e('If you’re collecting personal data this field is required for requesting the user explicit consent','simpleform') ?></p></td></tr>
...
<tr class="trcaptcha trcaptchalabel <?php if ( $captcha_field !='hidden' ) {echo 'visible';} else {echo 'unseen';} ?>"><th class="option"><span><?php esc_html_e('Captcha Field Label','simpleform') ?></span></th><td class="text"><input type="text" class="sform" id="captcha_label" name="captcha_label" placeholder="<?php esc_html_e('Enter a label for Captcha field','simpleform') ?>" value="<?php echo $math_captcha_label ?>"></td></tr>
